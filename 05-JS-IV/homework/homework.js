...
function sumarLikesDeUsuario(usuario) {
  ...
  //    likes: entero
  // }
  // usuario.posts.length --> cantidad de posiciones en el array
  // usuario.posts[i].likes --> para acceder al valor de likes dentro del objeto que forma parte del array
